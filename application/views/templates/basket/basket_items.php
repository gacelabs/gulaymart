<?php if ($data_baskets): ?>
	<?php foreach ($data_baskets as $location_by_order_type => $baskets): ?>
		<?php
		...
		<div class="order-table-item">
			<div class="order-grid-column order-labels">
				<div class="text-left">
					<p><small class="elem-block"><b>PRODUCT</b><i>- <?php echo date('M. j, Y | g:i a', strtotime($baskets['added']));?></i></small></p>
				</div>
	...
	<?php endforeach ?>
<?php endif ?>
<div class="no-records-ui<?php if (!empty($data_baskets)): ?> hide<?php endif ?>" style="text-align:center;background-color:#fff;padding:40px 10px;">
