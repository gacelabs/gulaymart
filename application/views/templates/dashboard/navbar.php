	...
	<div class="container-fluid">
		<div id="dashboard_navbar_grid">
			...
			<div id="dashboard_navbar_btn_list" class="zero-gaps">
				<a href="marketplace/" class="text-link hidden-xs" style="display:inline-block;margin:8px 10px;">Home</a>
				<a href="profile/" class="v-top"><div id="global_navbar_avatar" style="background-image: url('assets/images/avatar.jpg');"></div></a>
			</div>
		</div>
	</div>
</div>