...
<div class="container">
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
		...
		<p style="margin-bottom:5px;"><a href="marketplace/category/leafy">Leafy</a></p>
		<p style="margin-bottom:5px;"><a href="marketplace/category/root">Root</a></p>
		<p style="margin-bottom:5px;"><a href="marketplace/category/cruciferous">Cruciferous</a></p>
		<p style="margin-bottom:5px;"><a href="marketplace/category/marrow">Marrow</a></p>
		<p style="margin-bottom:5px;"><a href="marketplace/category/stem">Stem</a></p>
		<p style="margin-bottom:5px;"><a href="marketplace/category/allium">Allium</a></p>
	</div>
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
