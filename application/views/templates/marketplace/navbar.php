	...
	<div class="container marketplace-navbar-container">
		<div id="search_with_nav_btns">
			...
			<ul id="search_nav_btns">
				...
				<li class="nav-avatar-li onlogged-in-btns<?php echo $current_profile ? '' : ' hide';?>"><a href="profile"><div class="nav-avatar-body" style="background-image: url('assets/images/avatar.jpg');"></div></a></li>
			</ul>
		</div>
	</div>
</div>