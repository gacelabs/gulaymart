<div class="modal fade" id="veggy_product_pricing_help" tabindex="-1" role="dialog" aria-labelledby="veggy_product_pricing_helpLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default normal-radius" data-dismiss="modal" aria-label="Close">Got it!</button>
			</div>
		</div>
	</div>
</div>
<div class="modal fade" id="veggie_category_help" tabindex="-1" role="dialog" aria-labelledby="veggie_category_helpLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						...
						<div class="panel-heading" role="tab" id="headingOne">
							<h4 class="panel-title">
								<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
									<img src="assets/images/categories/leafy.png" style="width:30px;"> Leafy
								</a>
							</h4>
						</div>
