<div class="modal fade" id="farm_identity_help" tabindex="-1" role="dialog" aria-labelledby="farm_location_helpLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title">Farm Identity</h4>
			</div>
			<div class="modal-body">
				...
				<h5>A good farm name should have...</h5>
...
<div class="modal fade" id="farm_location_help" tabindex="-1" role="dialog" aria-labelledby="farm_location_helpLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
