	...
	<div class="container marketplace-navbar-container">
		<div id="search_with_nav_btns">
			...
			<ul id="search_nav_btns">
				...
				<li id="nav_basket" class="bottom-nav-item onlogged-in-btns<?php echo $current_profile ? '' : ' hide';?>"><a href="basket"><i class="fa fa-shopping-basket"></i></a></li>
				<li class="nav-avatar-li onlogged-in-btns<?php echo $current_profile ? '' : ' hide';?>">
					<a href="profile">
						<div class="nav-avatar-body" style="background-image: url('assets/images/avatar.jpg');"></div>
						<i class="fa fa-gear" id="profile_icon_badge"></i>
					</a>
				</li>
			</ul>
		</div>
