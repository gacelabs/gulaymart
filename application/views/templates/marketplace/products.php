<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="product_item_container">
	<div class="product-item-body">
		...
		<div class="hide <?php echo $current_profile ? "" : "in"; ?>" id="bottom_nav_sm">
			...
			<div class="bottom-nav-item onlogged-in-btns<?php echo $current_profile ? '' : ' hide';?>"><span data-toggle="tooltip" data-placement="top" title="Log Out"><a href="sign-out"><i class="fa fa-sign-out"></i></a></span></div>
		</div>
	</div>
</div>