	...
	<div class="row" id="productpage_middle">
		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
			...
			<div class="panel productpage-farm-info">
				...
				<div class="cover_image" id="storefront_page_container" style="margin-bottom:0;">
					<div class="storefront-top">
						<div class="storefront-img-bg" style="background-image: url(assets/images/lettuce-house.jpg);">
							<div id="farm_identity">
								<ul class="grid-list half">
									<li class="text-left">
										<h1 class="farm_name"><a href="store/1/ema-and-ava-farm">ema and ava farm</a></h1>
										<h4 class="tagline">the freshest veggies in town!</h4>
									</li>
									<li class="text-right"><div class="profile_photo" style="background-image: url(assets/data/files/medias/poi-gmail.com/me.png);"></div></li>
								</ul>
							</div>
						</div>
					</div>
