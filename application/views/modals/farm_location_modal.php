	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" style="margin-bottom: 15px;">Search Farm Location</h4>
				<p class="zero-gaps">Saving the <b>exact location address</b> of your farm is important. This will be used as the <b>pick up point</b> of your listed products.</p>
			</div>
