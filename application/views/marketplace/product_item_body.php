<div class="product-item-body" id="product_item_body">
	...
	<!-- <div class="hide <?php if ($page_data['is_login'] == 0) {echo "in";} ?>" id="bottom_nav_sm">
		<div class="bottom-nav-item <?php if (in_array("marketplace", $body_class)) {echo "active";} ?>" data-toggle="tooltip" data-placement="top" title="Gulaymart"><a href=""><i class="fa fa-leaf"></i></a></div>
	<?php if ($page_data['is_login'] == 1) : ?>
		<div class="bottom-nav-item" data-toggle="tooltip" data-placement="top" title="Notifications"><a href="notifications"><i class="fa fa-bell-o"></i></a></div>
		...
		<div class="bottom-nav-item" data-toggle="tooltip" data-placement="top" title="Basket"><a href="basket"><i class="fa fa-shopping-basket"></i></a></div>
		<div class="bottom-nav-item" data-toggle="tooltip" data-placement="top" title="Username Here"><a href="account"><div class="nav-avatar-body" style="background-image: url('assets/images/avatar.jpg');"></div></a></div>
	<?php else : ?>
		<div class="bottom-nav-item" data-toggle="modal" data-target="#search_popup"><i class="fa fa-search" data-toggle="tooltip" data-placement="top" title="Search"></i></div>
	...
	<div class="hide <?php if ($page_data['is_login'] == 0) {echo "in";} ?>" id="bottom_nav_sm">
		<div class="bottom-nav-item <?php if (in_array("marketplace", $body_class)) {echo "active";} ?> onlogged-out-btn<?php echo $current_profile ? ' hide' : '';?>" data-toggle="tooltip" data-placement="top" title="Gulaymart"><a href=""><i class="fa fa-leaf"></i></a></div>
