	...
	<div class="row" id="productpage_top">
		<div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
			<div class="product-imgs-container">
				<div id="main_img_preview" style="background-image: url(assets/images/product-item/onions.jpg);"></div>
				<div class="img-thumb-container">
					<ul class="inline-list" id="img_thumb_list">
						<li><div class="img-thumb-item active" style="background-image: url(assets/images/product-item/onions.jpg);"></div></li>
						<li><div class="img-thumb-item" style="background-image: url(assets/images/product-item/veg.jpg);"></div></li>
						<li><div class="img-thumb-item" style="background-image: url(assets/images/product-item/veggies.jpg);"></div></li>
						<li><div class="img-thumb-item" style="background-image: url(assets/images/product-item/veg.jpg);"></div></li>
						<li><div class="img-thumb-item" style="background-image: url(assets/images/product-item/veggies.jpg);"></div></li>
					</ul>
				</div>
		...
		<div class="col-lg-4 col-md-4 col-sm-7 col-xs-12">
			<div class="productpage-basic-container">
				<div class="cat-breadcrumb">
					<p class="text-gray zero-gaps"><a href="">Allium</a> <i class="fa fa-angle-right"></i> <a href="">Onions</a></p>
				</div>
				<h1 class="productpage-title">Organic Freshly Picked Sweet White Onions</h1>

				<h2 class="productpage-price"><span class="text-gray">&#x20b1;</span> <span class="text-contrast">120</span> <span class="text-gray">-</span> <span class="text-contrast">200</span></h2>
				<hr>
				<form action="" method="post">
						...
						<div class="productpage-variety">
							<div class="variety-location">
								<div class="input-group">
									<span class="input-group-addon addon-variety-input"><span class="text-gray">&#x20b1; 120</span></span>
								...
								<p style="margin-top:5px;"><i class="fa fa-map-marker"></i> Bulacan - <span class="max-qty">Max quantity 40</span></p>
							</div>
						</div>
					</div>
					...
					<div class="add-basket-btn">
						...
						<button type="button" class="btn btn-lg btn-contrast" style="width:125px;">Buy Now</button>
					</div>
				</form>
			</div>
		</div>
